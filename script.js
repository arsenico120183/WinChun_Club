...
// Gestione degli altri link principali
document.querySelector('.links > .link-card:nth-child(3)').addEventListener('click', function(e) {
    e.preventDefault();
    // Gestione click su "Gli Istruttori"
});

document.querySelector('.links > .link-card:nth-child(4)').addEventListener('click', function(e) {
    e.preventDefault();
    // Gestione click su "Dove Trovarci"
});

document.querySelector('.links > .link-card:nth-child(5)').addEventListener('click', function(e) {
    e.preventDefault();
    // Gestione click su "Contatti"
});

document.querySelector('.links > .link-card:nth-child(6)').addEventListener('click', function(e) {
    e.preventDefault();
    // Gestione click su "Foto e Video"
});

document.querySelector('.links > .link-card:nth-child(7)').addEventListener('click', function(e) {
    e.preventDefault();
    // Gestione click su "Social"
}); 